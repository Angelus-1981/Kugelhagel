...
<gameSystem id="3c2e-756d-e8b8-08bb" name="Kugelhagel" revision="2" battleScribeVersion="2.03" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  ...
  <costTypes>
    <costType id="Punkte" name="Pkt" defaultCostLimit="-1.0" hidden="false"/>
  </costTypes>
  <profileTypes>
  ...
  <categoryEntries>
    <categoryEntry id="5ffa-b549-d6a5-7801" name="Geschlossene Formation" publicationId="0f5a-f65b-32e8-9be9" page="16" hidden="false">
      <constraints>
        <constraint field="selections" scope="force" value="3.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="b79b-4f32-8f2e-4178" type="min"/>
      </constraints>
    </categoryEntry>
    ...
    <categoryEntry id="2507-27cc-ac90-eeef" name="Garde-Infanterie" publicationId="0f5a-f65b-32e8-9be9" page="53" hidden="false"/>
    <categoryEntry id="99e5-edeb-bb33-587a" name="Garde-Kavallerie" hidden="false"/>
    <categoryEntry id="9edb-aa1d-6ae0-1e74" name="Garde-Artillerie" publicationId="0f5a-f65b-32e8-9be9" hidden="false"/>
  </categoryEntries>
  <forceEntries>
    <forceEntry id="8c6b-a7d1-8a27-fecf" name="Gemischte Brigade" publicationId="0f5a-f65b-32e8-9be9" page="53" hidden="false">
      <categoryLinks>
        ...
        <categoryLink id="b31d-a709-5800-678c" name="Fußartillerie" hidden="false" targetId="1e1e-7117-264c-3b3f" primary="false">
          <modifiers>
            <modifier type="increment" field="eae9-c259-4741-de5a" value="1">
              <repeats>
                <repeat field="selections" scope="force" value="3.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" childId="8d8b-27a9-8639-1b9c" repeats="1" roundUp="false"/>
              </repeats>
            </modifier>
          </modifiers>
          <constraints>
            <constraint field="selections" scope="force" value="0.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" id="eae9-c259-4741-de5a" type="max"/>
          </constraints>
        </categoryLink>
        <categoryLink id="1433-4e14-3322-3b79" name="Berittene Artillerie" hidden="false" targetId="086f-ca18-17d0-81bf" primary="false">
          <modifiers>
            <modifier type="increment" field="17cc-a8bc-f40e-a675" value="1">
              <repeats>
                <repeat field="selections" scope="force" value="3.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" childId="f7e6-223b-aab0-2b0f" repeats="1" roundUp="false"/>
              </repeats>
            </modifier>
          </modifiers>
          <constraints>
            <constraint field="selections" scope="force" value="0.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" id="17cc-a8bc-f40e-a675" type="max"/>
          </constraints>
        </categoryLink>
        <categoryLink id="e6fd-7d30-ac78-476c" name="Garde" hidden="false" targetId="192d-37f4-a0ff-389c" primary="false">
          <modifiers>
            <modifier type="increment" field="51d6-5649-341b-e985" value="1">
              <repeats>
                <repeat field="selections" scope="force" value="2.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="22d0-4211-7b42-450d" repeats="1" roundUp="false"/>
              </repeats>
            </modifier>
          </modifiers>
          <constraints>
            <constraint field="selections" scope="force" value="0.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" id="51d6-5649-341b-e985" type="max"/>
          </constraints>
        </categoryLink>
      </categoryLinks>
    </forceEntry>
...
Infanterie kann auch freiwillig ins Karree gehen. Diese Formationsänderung kostet sie eine Aktion. Dabei ist zu beachten, dass keine feindliche Einheit im Umkreis von 10 cm sein darf. Plänkler zählen nicht, wie bei jeder anderen Formationsänderung auch. Wenn die Infanterieeinheit bereits im Karree ist, darf sie als Angriffsreaktion defensives Feuer schießen.</description>
    ...
    <rule id="4191-f910-df9e-501a" name="Kundschafter" publicationId="0f5a-f65b-32e8-9be9" page="40" hidden="false">
      <description>Bewegen sich mit halber Bewegung durch Wald (und nur durch Wald). Volle Bewegung durch schwieriges Gelände. Sie haben eine höhere Sichtweite als reguläre Einheiten (siehe Kapitel Aufklärung von Nebelmarkern).</description>
    </rule>
    ...
    <rule id="213e-b3fb-7b9e-4b7f" name="Nichts wie weg" publicationId="0f5a-f65b-32e8-9be9" page="40" hidden="false">
      <description>Kavallerieeinheiten erleiden einen zusätzlichen Treffer gegen den sie einen normalen Rettungswurf haben, wenn sie sich aus einem Nahkampf bewegen müssen. Sie müssen sich immer aus dem Nahkampf bewegen, auch bei einem unentschiedenen Nahkampfergebnis; nur nicht bei einem Moralwerttestwurf von einer Doppeleins.
Artillerieeinheiten dürfen nicht defensives Feuer als Angriffsreaktion wählen, sondern müssen sich immer zurückziehen.</description>
    </rule>
    ...
    <rule id="98fa-ad8b-bff5-ffc0" name="Schockkavallerie +1" publicationId="0f5a-f65b-32e8-9be9" page="41" hidden="false">
      <description>Darunter fällt alle schwere Schlachtkavallerie. Sie erhält je nach Ausprägung W3 bzw. 1 Würfel zusätzlich im Angriff. DIes gilt nur bei Erstkontakt mit einer Einheit, nicht in bestehenden Nahkämpfen.</description>
    </rule>
    ...
    <rule id="437c-ffed-ec23-d02d" name="Starrsinning" publicationId="0f5a-f65b-32e8-9be9" page="41" hidden="false">
      <description>Die Einheit beharrt auf ihrem Standpunkt und ihrer Stellung. Sie ignoriert den ersten fälligen Moralwerttest im Spiel. Es wird angenommen sie hat ihn bestanden.</description>
    </rule>
    ...
    <rule id="4b37-78fb-6165-dbbe" name="Ungestüm" publicationId="0f5a-f65b-32e8-9be9" page="41" hidden="false">
      <description>DIe Einheit darf 3 verpatzte Trefferwürfe im Angriff wiederholen. Die gilt nur bei Erstkontakt mit einer Einheit, nicht in bestehenden Nahkämpfen.</description>
    </rule>
  </sharedRules>
</gameSystem>